...
//!
//! 此 crate 在 `roundo_algorithm::graph::OrderedRootedTree` 的通用 topology
//! 之上拥有 lifecycle independence、Survival Boundary、destruction plan/version
//! 与原子提交语义。它不依赖 Bevy、ECS 调度或资源清理；平台 adapter 负责把
//! 提交结果映射为 WebView 等外部资源操作。
//!
