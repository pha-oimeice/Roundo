...
pub struct VoxelRaycastHit {
    ...
    /// Complete primitive voxel data with its local-coordinate-space position.
...
mod tests {
    use super::*;
    use crate::local_coordinate::data::{AtomicVoxelData, LocalCoordinate, SOLID_VOXEL_ID};
    use bevy::{
    ...
    fn returns_the_first_voxel_with_point_normal_and_chunk_information() {
        ...
        assert_eq!(hit.voxel, solid_voxel(IVec3::new(1, 2, 3)));
    }
